...
- When Running for for the first time, Run terminal as administrator <br/>
...
- Follow the steps shown on the screen for your required job.<br/>
- Note: once the required packages are installed, you do not need to run the script via terminal again, simply double click on the script
